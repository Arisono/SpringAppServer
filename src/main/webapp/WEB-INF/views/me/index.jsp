...
<link href="<c:url value="/resources/jsonview/jquery.jsonview.css" />"
	rel="stylesheet" type="text/css" />
<script
	src="<c:url value="/resources/jsonview/jquery.jsonview.min.js" />"></script>
...
<body>
	...
	<div id="header">
		<a class="ui-button ui-widget ui-corner-all"
			href="<c:url value="/" />">进入英文界面</a> <a
			href="http://jqueryui.com/accordion/#collapsible">当前主题:JqueryUi</a>
		<div id="header_right" style="float: right;">
			<%
				String sessionId = (String) request.getSession().getAttribute(
						"sessionId");
			%>
			<a style="float: left; margin: 5px" href="">用户名：<%=sessionId%></a> <a
				style="float: left;" class="ui-button ui-widget ui-corner-all"
				href="<c:url value="/client/login" />">登陆</a> <a
				style="float: right;" class="ui-button ui-widget ui-corner-all"
				href="<c:url value="/client/logout" />">注销</a>
		</div>
		<p>
	</div>
	...
	<div id="tabs">
		...
		<!--Cookie与Session  -->
		<div id="tabs-1"
			style="margin: 0; padding: 0; overflow: hidden; zoom: 1;">
			<div id="accordion_left"
				style="width: 30%; float: left; padding-right: 5px">
				<h3>查看登陆状态</h3>
				<div id="json_login">
			...
			<div id="accordion_center" style="width: 39%; float: left;">
				<h3 style="background-color: #383838; border-color: #9AFF9A">Token</h3>
				<div
					style="height: 1000px; background-color: #D4D4D4; clear: inherit;">
					<div>
						<ul>
							<li>Token失效时间问题</li>
							<li>Token强制踢出问题</li>
			...
			<div id="accordion_right"
				...
				<h3>cookies知识</h3>
				<div>
					<p>Cookie是在浏览器缓存的数据</p>
				</div>
			</div>

			<div id="accordion_right_center"
				style="width: 30%; float: right; padding-left: 5px">
				<h3>jquery插件</h3>

				<div>
					<ul>
						<li><a href="/spring-mvc-showcase/freez">jquery 固定首行首列
								表格1</a></li>
						<li><a href="/spring-mvc-showcase/freez1">jquery 固定首行首列
								表格2</a></li>
					</ul>
				</div>
