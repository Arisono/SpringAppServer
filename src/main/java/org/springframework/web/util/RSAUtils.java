...
public class RSAUtils {
    ...
    /** RSA密钥长度必须�?64的�?�数，在512~65536之间。默认是1024 */
    ...
    public static void main(String[] args) {
        ...
        //密文
        byte[] encodedText = RSAEncode(Base64.decodeBase64(public_key), PLAIN_TEXT.getBytes());
//        System.out.println("RSA encoded: " + Base64.encodeBase64String(encodedText));
        System.out.println("RSA decoded: " + RSADecode(Base64.decodeBase64(private_key), encodedText));
    }
    ...
    /**
     * 还原公钥，X509EncodedKeySpec 用于构建公钥的规�?
     * 
     * @param keyBytes
     * @return
     */
    ...
    /**
     * 还原私钥，PKCS8EncodedKeySpec 用于构建私钥的规�?
     * 
     * @param keyBytes
     * @return
     */
